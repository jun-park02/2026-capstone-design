...
from app.api.v1.endpoints import dashboard, drones, fire_events, heatmaps, map_data, notification_recipients, streams, system
...
router.include_router(drones.router2)
router.include_router(map_data.router)
router.include_router(heatmaps.router)
